      ...
      <div className="w-full lg:w-10/12 px-4">
        <div className="relative flex lg:flex-row flex-col min-w-0 break-words w-full mb-6">
          <div className="flex-auto w-full p-5 lg:p-10">
            <H3 color="gray">More Information</H3>
          ...
          <div className="flex-auto w-full p-5 lg:p-10">
            ...
            <div
              ...
              role="alert"
            >
              <span class="font-medium">message sent successfully!</span> We
              will get to you within 24hours.
            </div>
            <div
              id="alert_danger"
              ...
              role="alert"
            >
              <span class="font-medium">Not sent!</span> We had difficulty
              sending the message, please resend it shortly.
            </div>
